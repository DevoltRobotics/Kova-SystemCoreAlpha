...
public class MecanumMechanism extends Mechanism implements NTSendable {
    ...
    PIDController xController = new PIDController(4.8, 0, 0);
    PIDController yController = new PIDController(4.8,0, 0);
    PIDController headingController = new PIDController(0.05, 0, 0);
    ...
    public MecanumMechanism(
        ...
        SendableRegistry.add(this, "MecanumMechanism");
        ...
        Scheduler.getDefault().addPeriodic(() -> {
            ...
            SmartDashboard.putData(headingController);
        });
    }
    ...
    public Command driveToPointCmd(Pose2d targetPose, double maxThrottle) {
        return run(co -> {
            ...
            do {
                ...
                drive.driveCartesian(yOutput, xOutput, headingOutput, currentPose.getRotation());
